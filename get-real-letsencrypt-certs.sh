...
# 🔐 Get REAL Let's Encrypt SSL certificates (not self-signed)
# This script gets production Let's Encrypt certificates and downloads them locally

set -e

echo "🔐 Getting REAL Let's Encrypt SSL certificates..."
echo "================================================================="
