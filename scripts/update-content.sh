...
echo "   https://balancer.svdevops.tech?t=$(date +%s)"
echo "   https://web1.svdevops.tech?t=$(date +%s)"
echo "   https://web2.svdevops.tech?t=$(date +%s)"
echo "   https://stats.svdevops.tech?t=$(date +%s)"
